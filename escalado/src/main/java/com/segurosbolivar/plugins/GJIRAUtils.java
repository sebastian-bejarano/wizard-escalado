...
public class GJIRAUtils {
    ...
    public static boolean crearIncidenteProductivoEnlazado(String projectKey, String mainIssueKey, String problemKey, String nuevoNombre,String prioridad, String momentoError, String severidad, String fabricaDesarrollo, String motivoEscalamiento, String epica, String nuevoResponsable,JiraAuthenticationContext authenticationContext, Map params, ProjectService projectService, ConstantsManager constantsManager, IssueService issueService, IssueLinkService issueLinkService, FieldManager fieldManager, CustomFieldManager customFieldManager, OptionsManager optionsManager, SearchService searchService) throws ServletException{
        ...
        String opcionParaBuscar = mainIssue.getCustomFieldValue(fieldManager.getCustomField("customfield_18009")).toString();
    ...
    public static boolean updateIssueStatus(Issue issue, boolean isServiceRequest,String nuevoResponsable, JiraAuthenticationContext authenticationContext, IssueService issueService){
        ...
        if(result.getErrorCollection().hasAnyErrors()){
            ...
            IssueService.TransitionValidationResult statusResult;
            switch(issue.getStatus().getId()){
                case "10254":
                    statusResult = issueService.validateTransition(user,issue.getId(),!isServiceRequest ? 191 : 961,inputParameters);
                    break;
                case "10266":
                    statusResult = issueService.validateTransition(user,issue.getId(),!isServiceRequest ? 161 : 961,inputParameters);
                    break;
                case "10265":
                    statusResult = issueService.validateTransition(user,issue.getId(),!isServiceRequest ? 131 : 961,inputParameters);
                    break;
                default:
                    statusResult = null;
                    break;
    ...
    public static IssueService.CreateValidationResult crearProblemaAsociado(JiraAuthenticationContext authenticationContext, IssueService issueService, Issue incident, String nuevoNombre, FieldManager fieldManager, CustomFieldManager customFieldManager, OptionsManager optionsManager, ProjectManager projectManager) throws ServletException{
        ...
        IssueInputParameters inputParameters = issueService.newIssueInputParameters()
                ...
                .addCustomFieldValue("customfield_10346", getOptionIdFromCustomField("customfield_10346",incident,authenticationContext,issueService,customFieldManager,optionsManager,fieldManager))
                ...
                .addCustomFieldValue("customfield_10418", incident.getCustomFieldValue(customFieldManager.getCustomFieldObject("customfield_10418")).toString());
        IssueService.CreateValidationResult result =  issueService.validateCreate(user,inputParameters);
        return result;
    }

    public static String getOptionIdFromCustomField(String customfield,Issue issue,JiraAuthenticationContext authenticationContext, IssueService issueService, CustomFieldManager customFieldManager, OptionsManager optionsManager, FieldManager fieldManager) throws ServletException{
